...
?><?$APPLICATION->IncludeComponent("bitrix:sale.order.ajax", "order_custom", Array(
	"ACTION_VARIABLE" => "soa-action",	// Название переменной, в которой передается действие
		"ADDITIONAL_PICT_PROP_4" => "-",	// Дополнительная картинка [каталог синтов]
		...
		"PATH_TO_PERSONAL" => "/personal/history/",	// Путь к странице персонального раздела
