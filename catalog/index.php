...
?><?$APPLICATION->IncludeComponent("bitrix:catalog", "bootstrap_v4_mod", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_TYPE" => "synth_shop",	// Тип инфоблока
		...
		"MESS_NOT_AVAILABLE_SERVICE" => "заказать",	// Сообщение о недоступности услуги
		...
		"TEMPLATE_THEME" => "black",	// Цветовая тема
		...
		"TOP_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'3','BIG_DATA':false},{'VARIANT':'3','BIG_DATA':false}]",	// Вариант отображения товаров
